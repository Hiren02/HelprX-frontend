            ...
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Stay updated with your bookings and account activity</p>
                    </div>
                    {unreadCount > 0 && (
                        <Button
                ...
                <div className="flex border-b border-gray-200 mb-6 gap-8">
                    ...
                    >
                        Unread
                        {unreadCount > 0 && (
                            <span className="ml-2 bg-primary-600 text-white px-2 py-0.5 rounded-full text-[10px]">
                                {unreadCount}
                            </span>
                        )}
                        {activeTab === 'unread' && (
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-2">
                        {filteredNotifications.map((notification, index) => (
                            ...
                            >
                                <Card
                                    className={`relative group p-0 transition-all duration-200 border-gray-100 shadow-sm hover:shadow-md ${!notification.isRead ? 'border-l-4 border-l-primary-600 bg-primary-50/10' : ''}`}
                                >
                                    <div className="flex items-start gap-4 p-4">
                                        <div className={`mt-1 p-2 rounded-lg ${!notification.isRead ? 'bg-primary-100 text-primary-600' : 'bg-gray-100 text-gray-500'}`}>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between gap-2 mb-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {!notification.isRead && (
                                                        <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-primary-600 text-white uppercase tracking-wider">
                                                            New
                                                        </span>
                                                    )}
                                                </div>
                                            ...
                                            {!notification.isRead && (
                                                <Button
                                                    ...
                                                    className="text-primary-600 hover:text-primary-700 hover:bg-primary-50 px-0 h-8 flex items-center gap-1.5"
                                                >
                    ...
                    <Card className="flex flex-col items-center justify-center py-20 text-center border-dashed border-2 border-gray-200 bg-transparent">
                        ...
                        <p className="text-gray-500 max-w-sm">
                            When you have any updates about your bookings or account, they will appear here.
                        </p>
                    </Card>
                )}
            </div>
