                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-col">
                          <span className="text-sm text-gray-600">{formatDate(tx.createdAt || (tx as any).created_at)}</span>
                          <span className="text-xs text-gray-400">{formatTime(tx.createdAt || (tx as any).created_at)}</span>
                        </div>
                      </div>
                    </div>
