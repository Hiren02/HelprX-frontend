        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/worker/forgot-password" className="text-sm text-secondary-600 hover:text-secondary-700">
                Forgot password?
              </Link>
            </div>

            <Button type="submit" className="w-full bg-secondary-600 hover:bg-secondary-700" isLoading={isLoading}>
              Sign In
            </Button>
          </form>
